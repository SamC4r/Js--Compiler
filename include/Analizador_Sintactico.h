...
class AnalizadorSintactico {
    ...
    map<string,string> numero_accion_semantica = {
        ...
        {"{dec_false}","B -> {zona_declaracion=false} S {B.tipo=S.tipo}"},
        {"{B->S}","B -> {zona_declaracion=false} S {B.tipo=S.tipo}"},
    ...
    map<pair<string, string>, string> M = {
        ...
        {{"Z", "if"}, "B {Z->BZ} Z"},
        {{"Z", "$"}, "lambda {Z->lambda}"},
        {{"B", "id"}, "{dec_false} S {B->S}"},
        {{"B", "input"}, "{dec_false} S {B->S}"},
        {{"B", "output"}, "{dec_false} S {B->S}"},
        {{"B", "return"}, "{dec_false} S {B->S}"},
        {{"B", "var"}, "var T id ;"},
        {{"B", "if"}, "if ( E ) I "},
        {{"T", "boolean"}, "boolean"},
        {{"T", "int"}, "int"},
